export {IfPlatformSupported,IfPlatformSupportedOptions} from './react/components/if-platform-supported.js'
...
export {useIsPlatformSupported} from './react/hooks/use-is-platform-supported.js'
